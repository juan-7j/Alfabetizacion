...
?>
    ...
    <head>
        ...
        <title>Tareas institucionales INEM</title>
        <meta charset="UTF-8">
    ...
    <body class="pt-5 mt-2 mt-md-0">
            ...
            <nav class="container-fluid navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
                <a class="navbar-brand" href="tareas.php">
                    <div class="row ">
                        ...
                        <h4 class="col-auto d-flex  align-items-center justify-content-start p-0 m-0 text-capitalize">
                            <strong class="d-none d-sm-block"><em> betizhe</em></strong>
                ...
                <div id="navegacion" class=" justify-content-sm-end collapse navbar-collapse">
                    <ul class="h4 navbar-nav  mt-3 list-group-horizontal justify-content-end">
                        ...
                        <li class="nav-item text-start mx-2 h2">
                            <a class="text-light nav-link active d-sm-inline d-md-inline text-black-50" href="tareas.php" title="Tareas"><i class="fa-solid fa-book"></i></a></a>
                        </li>
                        <li class="nav-item text-start mx-2 h2">
        ...
        <?php if (isset($_SESSION['mensajeDeTareasDir'])) { ?>

            <script>
                swal("<?php print $_SESSION['tituloDeTareasDir']; ?>", " <?php print $_SESSION['mensajeDeTareasDir']; ?> "
                    <?php if (isset($_SESSION['tipoTareasDir'])) { ?>, "<?php print $_SESSION['tipoTareasDir']; ?>"
                    <?php } ?>
                );
            </script>
        <?php unset($_SESSION['mensajeDeTareasDir'], $_SESSION['tituloDeTareasDir'], $_SESSION['tipoTareasDir']);
        } ?>
